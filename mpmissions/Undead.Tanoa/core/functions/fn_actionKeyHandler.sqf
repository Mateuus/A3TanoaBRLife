...
if(_curTarget isKindOf "House_F" && {player distance _curTarget < 12} OR ((nearestObject [[3652.1155,6381.9326,0.4],"Land_Dome_Big_F"]) == _curTarget OR (nearestObject [[3652.1155,6381.9326,0.4],"Land_Research_house_V1_F"]) == _curTarget)) exitWith {
