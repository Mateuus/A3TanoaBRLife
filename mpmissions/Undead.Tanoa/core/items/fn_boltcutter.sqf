...
if(((nearestObject [[3652.1155,6381.9326,0.4],"Land_Dome_Big_F"]) == _building OR (nearestObject [[3652.1155,6381.9326,0.4],"Land_Research_house_V1_F"]) == _building) && ({side _x == west} count playableUnits < (LIFE_SETTINGS(getNumber,"cops_online_min")))) exitWith {
...
if((nearestObject [[3652.1155,6381.9326,0.4],"Land_Dome_Big_F"]) == _building OR (nearestObject [[3652.1155,6381.9326,0.4],"Land_Research_house_V1_F"]) == _building) then {
